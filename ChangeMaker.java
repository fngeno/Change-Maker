...
public class ChangeMaker { 									// This program display change breakdown of coins in US currency the user enters.
	...
	public static void changeDue() { 				//Beginning of the method
		...
		change = change % 25;// Dividing by 25 to get quarters and casting in to integer to obtain the remaining change.

		int numberOfDimes = (int) (change / 10); // Dividing by 10 to find the dimes
		change = change % 10; // Division operator yields integer part, remainder operator obtains remainder of division
		...
		int numberOfpennies = (int) (change); // Remaining coins will be pennies
			...
			//Display below using If statements to allow only the coins to display on the change.
